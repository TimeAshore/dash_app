from sqlalchemy import Column, String, Integer, ARRAY, BigInteger, TEXT, Boolean

from .base import db, BaseColumns


class WebsiteBanned(db.Model, BaseColumns):
    __tablename__ = "website_banned"
    ...
    def __init__(self, **kwargs):
        for attr in ['url', 'domain', 'domain_id', 'city_code', 'region_code', 'ip', 'ip_area', 'title', 'web_type'
                     ...
                     'http_status_list', 'category', 'is_auto', 'group']:
    ...
    group = Column(String(100), server_default='')  # 分组
