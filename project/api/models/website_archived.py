...
class WebsiteArchived(db.Model, BaseColumns):
    __tablename__ = "website_archived"
    ...
    title = Column(String(254), server_default='')  # 标题|网站名称
    ...
    title_updated = Column(TIMESTAMP)  # 标题更新时间
    status_updated = Column(TIMESTAMP)  # 状态更新时间
