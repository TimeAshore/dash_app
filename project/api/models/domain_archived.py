# services/isip/project/api/models/domain_archived.py
from sqlalchemy import Column, String, TIMESTAMP, func, Boolean, Integer, ARRAY
from .base import db, BaseColumns


class DomainArchived(db.Model, BaseColumns):
    __tablename__ = 'domain_archived'
